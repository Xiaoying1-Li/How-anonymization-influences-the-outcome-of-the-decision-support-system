...
def write_to_file(result):
    """
    Write the anonymized result to anonymized.data with header.
    """
    header = ["age", "sex", "cp", "trestbps", "chol", "fbs", "restecg", "thalach", "exang", "oldpeak", "slope", "ca", "thal", "target", "index"]
    with open("data/anonymized_result/anonymized_a.data", "w") as output:
...
if __name__ == '__main__':
    ...
    if FLAG == 'k':
        ...
        print("Usage: python anonymizer.py [k | qi | data | one]")
